...
if ($LASTEXITCODE -ne 0) { throw "Transitive external dependency bootstrap failed." }
Write-Host ""
Write-Host "Bootstrap complete, including transitive external library dependencies."
