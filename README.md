...
| Phase | Duration |
| --- | ---: |
| Preflight + execution plan | 9.564 s |
| Cache restore | 752 ms |
| Runtime pull | 20.792 s |
| Capability materialization | 6.696 s |
| Cache save | 642 ms |
| Validation + finishing | 369 ms |
| Snapshot preparation | 1 ms |
| **Total to prepared snapshot** | **38.876 s** |
