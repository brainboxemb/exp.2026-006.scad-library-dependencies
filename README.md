...
| Phase | Duration |
| --- | ---: |
| Preflight + execution plan | 10.083 s |
| Cache restore | 647 ms |
| Runtime pull | 12.565 s |
| Capability materialization | 5.008 s |
| Cache save | 475 ms |
| Validation + finishing | 506 ms |
| Snapshot preparation | 3 ms |
| **Total to prepared snapshot** | **29.368 s** |
