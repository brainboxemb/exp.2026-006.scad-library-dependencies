...
| Phase | Duration |
| --- | ---: |
| Preflight + execution plan | 10.089 s |
| Cache restore | 866 ms |
| Runtime pull | 19.379 s |
| Capability materialization | 7.850 s |
| Cache save | 578 ms |
| Validation + finishing | 363 ms |
| Snapshot preparation | 2 ms |
| **Total to prepared snapshot** | **39.184 s** |
