...
| Phase | Duration |
| --- | ---: |
| Preflight + execution plan | 11.592 s |
| Cache restore | 883 ms |
| Runtime pull | 14.970 s |
| Capability materialization | 5.060 s |
| Cache save | 61 ms |
| Validation + finishing | 472 ms |
| Snapshot preparation | 3 ms |
| **Total to prepared snapshot** | **33.117 s** |
