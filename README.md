...
| Phase | Duration |
| --- | ---: |
| Preflight + execution plan | 8.467 s |
| Cache restore | 502 ms |
| Runtime pull | 14.246 s |
| Capability materialization | 7.126 s |
| Cache save | 456 ms |
| Validation + finishing | 493 ms |
| Snapshot preparation | 3 ms |
| **Total to prepared snapshot** | **31.368 s** |
