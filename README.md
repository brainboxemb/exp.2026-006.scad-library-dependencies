...
| Phase | Duration |
| --- | ---: |
| Preflight + execution plan | 9.813 s |
| Cache restore | 608 ms |
| Runtime pull | 14.089 s |
| Capability materialization | 6.870 s |
| Cache save | 1.181 s |
| Validation + finishing | 528 ms |
| Snapshot preparation | 3 ms |
| **Total to prepared snapshot** | **33.176 s** |
